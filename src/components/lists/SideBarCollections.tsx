    ...
    <div className="flex flex-col w-full h-[100dvh] bg-white dark:bg-black">
      ...
      <div className="h-full p-2 flex flex-col gap-2">
        {filteredCollections.map((collection: any) => (
          <div className="flex flex-row justify-between items-center px-4 py-2 rounded-xl bg-zinc-100 dark:bg-zinc-900 hover:bg-zinc-200 hover:dark:bg-zinc-800 text-black dark:text-white">
        ...
        <OriginalButton iconPosition="start" IconComponent={GoPlus} label="Create Collection" onClick={() => {toast("I will create a collection")}} />
      </div>
    </div>
  );
}
